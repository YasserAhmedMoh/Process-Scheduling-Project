...
{
    public partial class SJF_prem : Form
    {
        public SJF_prem()
        {
            InitializeComponent();
        ...
        private void SJF_nonprem_Load(object sender, EventArgs e)
        {
            create_p();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            int[] remaining = new int[MaxProsNum];
            ...
            foreach (Control c in groupBox3.Controls)
            {
                if (c is TextBox)
                {
                    ...
                    if (txt.Text != "")
                    {
                        ...
                        remaining[counter1] = int.Parse(c.Text);
                        counter1++;
